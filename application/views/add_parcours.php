        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" method="post" name =" createService" action="<?php echo base_url().'index.php/emploie/addparcours';?>">
              <div class="col-lg-12 ">
                ...
                <div class="form-floating">
                  <select class="form-select" id="floatingSelect" name="mention" aria-label="Floating label select example">
                    <option ></option>
                    
                      <?php 
                      $mention =$this->emploies_model->Allmention();
                      if($mention->num_rows() > 0) { foreach($mention->result() as $row){?>
                      <option value="<?php echo $row->IDMention ;?>" ><?php echo $row->NomDomaine.' / '.$row->NomMention.' / '.$row->NomEtab;?></option>
                      <?php } }?> 
               
                  </select>
                  <label for="floatingSelect">Mention</label>
