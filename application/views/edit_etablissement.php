    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Modifier l'etablissement</h5>

              <!-- Vertical Form -->
              <form class="row g-3" method="post" name =" createEmploie" action="<?php echo base_url().'index.php/emploie/edit/'.$etablissement['IDEtab'];?>">
              <div class="form-floating mb-1">
                    <input type="text" class="form-control" placeholder=" " value="<?php echo set_value('code',$etablissement['CodeEtab']);?>" name="code" id="floatingInput" aria-label="First name">
                    <label for="floatingInput">Code Etablissement</label>
                    <?php echo form_error('code');?>

                </div><br>
                <div class="form-floating mb-1">
                    <input type="text" class="form-control" placeholder=" " value="<?php echo set_value('nom',$etablissement['NomEtab']);?>" name="nom" id="floatingInput" aria-label="First name">
