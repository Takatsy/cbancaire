...
<div class="container">
<H4>Ajouter un Employeur</H4><hr>
<form method="post" name =" createEmploie" action="<?php echo base_url().'index.php/emploie/emp';?>">
    <div class="row">
        
        <div class="col-md-6 ">
                
                <div class="form-floating mb-1">
                    <input type="text" class="form-control" placeholder=" " value="<?php echo set_value('code');?>" name="matricule" id="floatingInput" aria-label="First name">
                ...
                <div class="form-floating mb-1">
                    <input type="date" class="form-control" placeholder=" " value="<?php echo set_value('libelle');?>" name="dateentrer" id="floatingInput" aria-label="First name">
        ...
        <div class="col-md-6 ">
        <div class="form-floating mb-1">
                    <input type="text" class="form-control" placeholder=" " value="<?php echo set_value('libelle');?>" name="nom" id="floatingInput" aria-label="First name">
                    <label for="floatingInput">Nom</label>
                    <?php echo form_error('libelle');?>
        </div><br>
        <div class="form-floating mb-1">
                    <input type="text" class="form-control" placeholder=" " value="<?php echo set_value('code');?>" name="prenom" id="floatingInput" aria-label="First name">
                ...
                <div class="form-floating mb-1">
                    <input type="number" class="form-control" placeholder=" " value="<?php echo set_value('libelle');?>" name="tel" id="floatingInput" aria-label="First name">
