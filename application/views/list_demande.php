...
<div class="row">
    ...
    <div class ="col-md-6">
        ...
        <a href="<?php echo base_url().'index.php/emploie/dema';?>" ><button class="btn btn-dark">Demender un congé</button></a>
    </div><br>
    <div class ="col-md-12"><H4>Liste des demendes de congé</H4></div>
    <hr>
        ...
        <div class="col ">
            <table class="table">
                <thead>
                    ...
                    <th scope="col">Code conge</th>
                    <th scope="col">Date de debut</th>
                    <th scope="col">Date de reprendre</th>
                    <th scope="col">Modifier</th>
                    <th scope="col">Supprimer</th>
                    </tr>
                </thead>
                <tbody>
                <?php if($demande->num_rows() > 0) { foreach($demande->result() as $row){?>
                    <tr>
                        <td><?php echo $row->MATRICULE;?></td>
                        <td><?php echo $row->CODECONGE;?></td>
                        <td><?php echo $row->DATEDEBUT;?></td>
                        <td><?php echo $row->DATEREPRENDRE;?></td>
                        <td><a href="<?php echo base_url().'index.php/emploie/editDemande/'.$row->MATRICULE;?>"><button type="button" class="btn btn-outline-dark">Modifier</button></a></td>
                        <td><a href="<?php echo base_url().'index.php/emploie/deleteDemande/'.$row->MATRICULE;?>"><button type="button" class="btn btn-outline-danger">Supprimer</button></a></td>
                    </tr>

                    <?php } } else {?>
                    <tr>
                        <td colspan="6">demande  non trouvé</td>
                    </tr>
                    <?php } ?>
                </tbody>
